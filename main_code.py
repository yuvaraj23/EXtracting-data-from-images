...
#def image_text(find_date,find_date1,find_date2,find_date3,find_date4, is_date):
...
#scanning image and extraction only text
img_pil = Image.open(data_folder+'0a8a955f.jpeg')
MAX_SIZE = 2000
...
#retrieve text from image and saving into variable
text=''
results = run(gray_pil)
for line in results:
    txt = line[1]+"  "
